                                                                        ...
                                                                        m_active_controller_type{ControllerType::kTrajectory}
{
    ...
    // Robot description path -- the default is /m_robot_name/robot_description, but it may be elsewhere
    ros::param::get("~robot_description", m_robot_description);

    // Should we start moveit actions?
    ros::param::get("~start_moveit", m_start_moveit);

    // Arm information
    urdf::Model model;
    model.initParam(m_robot_description);
